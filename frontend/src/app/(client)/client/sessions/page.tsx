...
export default function SessionsPage() {
  ...
  // Filtrage simple pour la démonstration
      ...
      <header className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] uppercase tracking-[0.4em] font-black text-[#c4a973]">Catalogue</span>
          </div>
        ...
        <div className="relative group max-w-md w-full">
          <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-[#c4a973] transition-colors" size={18} />
          <input 
            type="text"
      ...
      <section className="relative z-10">
        {filteredSessions.length > 0 ? (
          ...
          <div className="py-20 text-center border border-white/5 rounded-[3rem] bg-white/[0.02]">
            <p className="text-gray-500 font-medium italic">Aucun résultat ne correspond à votre recherche.</p>
          </div>
        )}
      </section>
